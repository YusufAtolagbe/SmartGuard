This is the firmware for the Home intrusion detector.
The Home intrusion detctor uses a PIR sensor to detect human presence and an esp32 microcontrller development board that connects to wifi.
